...
- Public ZIP inspection after adding demo recording assets: 55 entries, missing required entries 0, forbidden cache/private entries 0. Exact byte size is not a gate.
