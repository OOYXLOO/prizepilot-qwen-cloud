...
class PublicPagesTests(unittest.TestCase):
    def test_judge_pack_is_linked_from_public_hub(self) -> None:
        ...
        self.assertIn("pending Alibaba endpoint proof", hub)
    ...
    def test_readme_exposes_judge_pack_url(self) -> None:
        ...
        self.assertIn("Proof boundary: https://ooyxloo.github.io/prizepilot-qwen-cloud/judge-pack/", readme)
    ...
    def test_judge_manifest_is_machine_readable_and_boundary_safe(self) -> None:
        ...
        self.assertIn("Blog Post Award fit", manifest["reviewer_fast_path"][1]["purpose"])
        self.assertIn("pending Alibaba endpoint proof", manifest["reviewer_fast_path"][2]["purpose"])
