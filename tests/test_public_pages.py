...
class PublicPagesTests(unittest.TestCase):
    ...
    def test_readme_exposes_judge_pack_url(self) -> None:
        ...
        self.assertIn("Prepared next-update links, not public until a user-approved push and HTTP 200 recheck", readme)
    ...
    def test_public_update_digest_explains_local_public_boundary(self) -> None:
        ...
        self.assertIn("prepared next-update links", page)
        self.assertIn("approved push and HTTP 200 recheck", page)
